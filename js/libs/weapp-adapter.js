...
([
  ...
  function (module, exports) {
    ...
    var _wx$getSystemInfoSync = wx.getSystemInfoSync()
    var screenWidth = _wx$getSystemInfoSync.screenWidth
    var screenHeight = _wx$getSystemInfoSync.screenHeight
    var devicePixelRatio = _wx$getSystemInfoSync.devicePixelRatio
  ...
  function (module, exports) {
    ...
    var localStorage = {
      get length () {
        ...
        var keys = _wx$getStorageInfoSyn.keys
      ...
      key: function key (n) {
        ...
        var keys = _wx$getStorageInfoSyn2.keys
